...
public class HenCoder6Activity extends AppCompatActivity {
    ...
    TabLayout tabLayout;
    ViewPager pager;
    List<HenCoder6Activity.PageModel> pageModels = new ArrayList<>();

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_scale06, R.string.title_scale, R.layout.practice_scale06));
